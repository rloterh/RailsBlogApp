...
The big picture of **RailsBlogApp** a blogging app with an authentication system that allows posting and commenting from various users. This branch focuses on validating models and creating specs(unit tests) for the data model created in previous branch.
